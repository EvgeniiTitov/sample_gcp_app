...
class YOLOv4Tiny:
    path_to_dependencies = os.path.join(
        os.getcwd(), "yolov4_tiny", "dependencies"
    )
    dependencies = "yolov4tiny"
    conf_thresh = 0.2
    NMS_thresh = 0.1
    ...
    def __init__(
        ...
        try:
            ...
            raise e
        print(f"\nDarknet initialized with net resolution of:"
        ...
        print(f"Detecting classes:", " ".join(map(str, self.classes)))
